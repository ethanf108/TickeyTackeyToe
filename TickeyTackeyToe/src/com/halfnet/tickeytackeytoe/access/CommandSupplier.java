...
public interface CommandSupplier{
    ...
    /**
     * Only called if the player can pick the next sub-board to place in,
     * for example if they were chosen to play in the Top Left sub-board,
     * but that sub-board was already won.
